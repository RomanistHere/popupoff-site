...
<section
	class="min-h-screen py-16 flex justify-center items-center text-dark overflow-hidden"
	class:bg-bright={!isJsEnabled}
>
	<div class="flex flex-wrap max-w-7xl px-8 w-full">
		<div class="w-1/2 pr-24 relative -xl:w-3/5 -lg:w-full">
		...
		<div class="w-1/2 relative -xl:w-2/5 -lg:w-full -lg:flex -lg:justify-between">
			<ImageShowcase
				class="-top-52 -left-12 -2xl:-top-40 -xl:-left-20 -lg:static -lg:w-1/2 -lg:mx-4"
				text="Before"
				src="images/wo1.png"
				alt="example of website with popups"
			/>
			<ImageShowcase
				class="-bottom-52 -right-12 -2xl:-bottom-40 -xl:right-0 -lg:static -lg:w-1/2 -lg:mx-4"
				text="After"
				src="images/wi1.png"
